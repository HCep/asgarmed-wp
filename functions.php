...
function materialwp_setup() {
	...
	register_nav_menus( array(
		...
		'secondary' => __( 'Contact Menu', 'materialwp' ),
...
function cptui_register_gallery() {
	...
	$labels = [
		"name" => __( "Galeria", "zapgo" ),
		"singular_name" => __( "galeria", "zapgo" ),
	];

	$args = [
		"label" => __( "Galeria", "zapgo" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
...
function shortcode_of_gallery(){
	$result = '<section class="all-images-section container mx-auto" >';	
	$result .= '<div class="all-images" >';	
		$args = array(
			'post_type'      => 'galeria',
			'posts_per_page' => '12',
		...
		while ( $loop->have_posts() ) : $loop->the_post();
			global $product;
			$result .= '<div class="single-image">';
			
			$result .= '<a href="'. get_field('gallery_image')['url'] .'" ><img class="w-100" src="'. get_field('gallery_image')['url'] .' "></a>';
...
add_shortcode( 'galeria', 'shortcode_of_gallery' ); 
